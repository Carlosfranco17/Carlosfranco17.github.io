const ColumnContent = [
  {
    ...
    text: `
      ...
      En Gateway I.T, estamos comprometidos con la satisfacción del cliente y la mejora continua. Siempre buscamos nuevas formas de innovar y mejorar nuestras soluciones para asegurarnos de estar a la vanguardia de la tecnología y proporcionar los mejores resultados para nuestros clientes y la comunidad.
    `,
  },
  {
    title: 'Misión',
    ...
    text: `
      ...
      En resumen, en Gateway I.T estamos dedicados a proporcionar soluciones de alta calidad que optimicen los procesos y garanticen el desarrollo de nuestros clientes y la región en general, a través de la innovación, la colaboración y el compromiso con la sostenibilidad.
    `,
  },
  {
    title: 'Visión',
    ...
    text: `
      ...
      Estamos comprometidos con la sostenibilidad y la responsabilidad social, y trabajamos para garantizar que nuestras soluciones sean beneficiosas tanto para nuestros clientes como para la comunidad en general.

      En Gateway I.T, nos enorgullece ser una empresa que genera soluciones de impacto y que es reconocida por su excelencia en la industria de tecnología e innovación. Continuaremos trabajando arduamente para alcanzar nuestros objetivos y lograr nuestra visión de ser una empresa líder en el mercado nacional e internacional en el campo de la tecnología y la innovación.
    `,
  },
];
